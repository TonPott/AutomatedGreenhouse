...
public:
  ...
  bool initializeDimOffTarget();
  bool applyBrightness(uint8_t percent);
  bool verifyCurrentTarget();
  bool ensureShutdownReleased();
  bool energizeRelayCoil();
  void deenergizeRelayCoil();
  ...
  bool isRelayCoilEnergized() const;
  bool hasFault() const;
...
private:
  ...
  bool present_ = false;
  bool shdnReleased_ = true;
  bool relayCoilEnergized_ = false;
  bool fault_ = false;
