...
constexpr uint32_t LIGHT_SENSOR_PUBLISH_INTERVAL_MS = 900000UL;  // 15 minutes
...
constexpr uint8_t HA_MQTT_ENTITY_LIMIT = 72;
...
// Test 09 intentionally exposes the full RDAC range; final effective limits follow real-lamp validation.
...
constexpr uint8_t DEFAULT_LIGHT_ON_TARGET_PERCENT = 100;
constexpr uint8_t DEFAULT_LIGHT_OFF_TARGET_PERCENT = 0;
